package com.asma.BurgerTracker1.models;
...
public class Burger {
    ...
    private Long id;
    @NotNull
    @Size(min = 5, max = 200 , message = "burgerName must be provided")
    private String burgerName;
    @NotNull
    @Size(min = 5, max = 200, message = "restaurantName must be provided")
